...
describe('Interpreter', () => {
    ...
    it('should create a move for 2Lw', () => {
        const numberOfCubes = 3;
        const result = [...interpretNotation('2Lw', numberOfCubes)].map((d3group) =>
            d3group.map((d3) => d3.toVector())
        );
        expect(result).toEqual([
            [
    ...
    it("should create a move for 2L'", () => {
        const numberOfCubes = 3;
        const result = [...interpretNotation("2L'", numberOfCubes)].map((d3group) =>
            d3group.map((d3) => d3.toVector())
        );
        expect(result).toEqual([[[-2, 0, 0]]]);
    });
    ...
    it('should create a move for 2L2', () => {
        const numberOfCubes = 3;
        const result = [...interpretNotation('2L2', numberOfCubes)].map((d3group) =>
            d3group.map((d3) => d3.toVector())
        );
    ...
    it('should create a move for 2Lw2', () => {
        const numberOfCubes = 3;
        const result = [...interpretNotation('2Lw2', numberOfCubes)].map((d3group) =>
            d3group.map((d3) => d3.toVector())
        );
        expect(result).toEqual([
            [
    ...
    it('should create a move for 2Rw', () => {
        const numberOfCubes = 4;
        const result = [...interpretNotation('2Rw', numberOfCubes)].map((d3group) =>
            d3group.map((d3) => d3.toVector())
        );
        expect(result).toEqual([
            [
    ...
    it("should create a move for 2R'", () => {
        const numberOfCubes = 4;
        const result = [...interpretNotation("2R'", numberOfCubes)].map((d3group) =>
            d3group.map((d3) => d3.toVector())
        );
        expect(result).toEqual([[[3, 0, 0]]]);
    });
    ...
    it('should create a move for 2R2', () => {
        const numberOfCubes = 4;
        const result = [...interpretNotation('2R2', numberOfCubes)].map((d3group) =>
            d3group.map((d3) => d3.toVector())
        );
    ...
    it('should create a move for 2Rw2', () => {
        const numberOfCubes = 4;
        const result = [...interpretNotation('2Rw2', numberOfCubes)].map((d3group) =>
            d3group.map((d3) => d3.toVector())
        );
        expect(result).toEqual([
            [
    ...
    it('should create a move for 2Uw', () => {
        const numberOfCubes = 3;
        const result = [...interpretNotation('2Uw', numberOfCubes)].map((d3group) =>
            d3group.map((d3) => d3.toVector())
        );
        expect(result).toEqual([
            [
    ...
    it('should create a move for 2Dw', () => {
        const numberOfCubes = 3;
        const result = [...interpretNotation('2Dw', numberOfCubes)].map((d3group) =>
            d3group.map((d3) => d3.toVector())
        );
        expect(result).toEqual([
            [
    ...
    it('should create a move for 2Fw', () => {
        const numberOfCubes = 3;
        const result = [...interpretNotation('2Fw', numberOfCubes)].map((d3group) =>
            d3group.map((d3) => d3.toVector())
        );
        expect(result).toEqual([
            [
    ...
    it('should create a move for 2Bw', () => {
        const numberOfCubes = 3;
        const result = [...interpretNotation('2Bw', numberOfCubes)].map((d3group) =>
            d3group.map((d3) => d3.toVector())
        );
        expect(result).toEqual([
            [
    ...
    it('should loop the moves 3 times', () => {
        const numberOfCubes = 3;
        const result = [...interpretNotation('(FR)3', numberOfCubes)].map((d3group) =>
            d3group.map((d3) => d3.toVector())
        );
    ...
    it('should ignore parenthesis if no number follows times', () => {
        const numberOfCubes = 3;
        const result = [...interpretNotation('(FR)', numberOfCubes)].map((d3group) =>
            d3group.map((d3) => d3.toVector())
        );
    ...
    it('should ignore non matching parenthesis2', () => {
        const numberOfCubes = 3;
        const result = [...interpretNotation('FR)2', numberOfCubes)].map((d3group) =>
            d3group.map((d3) => d3.toVector())
        );
        expect(result).toEqual([[[0, 0, -1]], [[-3, 0, 0]]]);
    });
    ...
    it('should handle separators correctly', () => {
        const numberOfCubes = 3;
        const result = [...interpretNotation('F 2F', numberOfCubes)].map((d3group) =>
            d3group.map((d3) => d3.toVector())
        );
